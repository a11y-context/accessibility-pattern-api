...
[Guidepup](https://github.com/guidepup/guidepup) drives real VoiceOver and NVDA for announcement-level assertions ("the switch announces its name, role, and state"). It is heavier and slower; reserve it for regression coverage of golden patterns rather than every PR.
