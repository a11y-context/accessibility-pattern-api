...
<figure>
  <ThemedImage
    alt="Comparison of accessibility pass rates. Left: unassisted AI-generated UI passes automated accessibility checks about 12 percent of the time across eight frontier models. Right: with A11y Context applied at generation time, code reaches an 88 to 93 percent manual pass rate."
    sources={{
      light: useBaseUrl('/img/system-comparison-light.png'),
      dark: useBaseUrl('/img/system-comparison-dark.png'),
    }}
  />
  <figcaption>
    Unassisted, AI-generated UI passes accessibility checks only ~12% of the time across eight frontier models (Microsoft A11y LLM Eval). With A11y Context applied at generation time, code reaches an 88–93% manual pass rate in our experiments.
  </figcaption>
</figure>
...
The 12% figure above is Microsoft's cross-model automated baseline; in our own controlled experiment the manual pass rate rose from 63% to 88–93%.
