...
const PAGES = [
  ...
  {label: 'Basic Button · React (Web)', to: '/web/react/components/button.basic'},
  {label: 'Toggle Button · React (Web)', to: '/web/react/components/button.toggle'},
  {label: 'Carousel with Dot Navigation · React (Web)', to: '/web/react/components/carousel.dots'},
  {label: 'Carousel with Thumbnail Navigation · React (Web)', to: '/web/react/components/carousel.thumbnails'},
  {label: 'Collection Row · React (Web)', to: '/web/react/components/collection-row.basic'},
  {label: 'Autocomplete Combobox · React (Web)', to: '/web/react/components/combobox.autocomplete'},
  ...
  {label: 'Channel Guide Grid · React (Web)', to: '/web/react/components/grid.channel-guide'},
  ...
  {label: 'Navigation Menu · React (Web)', to: '/web/react/components/navigation-menu.basic'},
  {label: 'Navigation Dropdown · React (Web)', to: '/web/react/components/navigation-menu.dropdown'},
  {label: 'Select · React (Web)', to: '/web/react/components/select.basic'},
  {label: 'Native Select · React (Web)', to: '/web/react/components/select.native'},
  ...
  {label: 'Basic Button · SwiftUI (iOS)', to: '/ios/swiftui/components/button.basic'},
  {label: 'Toggle Button · SwiftUI (iOS)', to: '/ios/swiftui/components/button.toggle'},
